	...
	<div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay"
		...
		<div class="eqLogicThumbnailContainer">
			<div class="cursor eqLogicAction" data-action="add"
				style="text-align: center; background-color: #ffffff; height: 200px; margin-bottom: 10px; padding: 5px; border-radius: 2px; width: 160px; margin-left: 10px;">
					...
					<form class="form-horizontal">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="eqLogicAttr form-control"
										data-l1key="configuration" data-l2key="addr"
								...
								<div class="col-sm-5">
        								...
        								<div class="col-sm-3">
        									<input type="text" class="eqLogicAttr" size="6"
        										data-l1key="configuration" data-l2key="timeout"
        										placeholder="{{Timeout}}" />
        								</div>
        						</div>
        					</div>
